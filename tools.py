...
tool_cmd   = [
                ...
                #5
                ["wget -O /tmp/Webscan._temp_joom_check --tries=1 ","/administrator"],
                ...
                #75
                ["wget -O /tmp/Webscan._temp_aspnet_elmah_axd --tries=1 ","/elmah.axd"],
                ...
                #78
                ["wapiti "," -f txt -o Webscan._temp_wapiti"],
